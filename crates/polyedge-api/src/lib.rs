...
pub use runtime::QsetV4WriterRetirementReceipt;
...
impl ApiShutdown {
    ...
    pub async fn prepare_qset_v4_retirement(
        ...
        self.runtime.prepare_qset_v4_retirement().await
    }
}
...
pub fn app_with_shutdown(settings: RuntimeSettings) -> (Router, ApiShutdown) {
    ...
    let router = Router::new()
        ...
        .nest("/api/v1/query", query::router())
        .route(
            "/api/v1/data-quality/timeline",
            get(labs::data_quality_timeline),
        )
