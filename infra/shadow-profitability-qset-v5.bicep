...
var campaignId = 'campaign-2026-08-26-qset-v5'
var rawContainerName = 'polyedge-shadow-qset-v5-events'
var researchContainerName = 'polyedge-research-qset-v5'
var controlContainerName = 'polyedge-qset-v5-control'
var eventIndexTableName = 'ShadowQsetV5EventIndex'
var chartSeriesTableName = 'ShadowQsetV5ChartSeries'
var marketCatalogTableName = 'ShadowQsetV5MarketCatalog'
var writerIdentityName = 'id-polyedge-conduit-shadow-qset-v5-writer'
var processorIdentityName = 'id-polyedge-conduit-shadow-qset-v5-processor'
...
resource writerRawContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    description: 'Only write or append qset-v5 preflight and campaign raw prefixes; the custom role has no delete, move, or container actions.'
  }
}
...
resource processorCampaignWriter 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    description: 'Only write or append qset-v5 campaign research and report prefixes; the custom role has no delete, move, or container actions.'
  }
}
