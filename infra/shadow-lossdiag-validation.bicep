...
var validationId = 'campaign-2026-07-23-lossdiag-v5'
      ...
      containers: [
        {
          ...
          env: [
            ...
            { name: 'LOSSDIAG_VALIDATION_CONFIG', value: '/app/research/configs/shadow_lossdiag_validation_2026-07-23_v5.json' }
          ]
          resources: {
            cpu: json('4')
            memory: '8Gi'
