...
var campaignId = 'campaign-2026-09-02-qset-v7'
var rawContainerName = 'polyedge-shadow-qset-v7-events'
var researchContainerName = 'polyedge-research-qset-v7'
var controlContainerName = 'polyedge-qset-v7-control'
var eventIndexTableName = 'ShadowQsetV7EventIndex'
var chartSeriesTableName = 'ShadowQsetV7ChartSeries'
var marketCatalogTableName = 'ShadowQsetV7MarketCatalog'
var writerIdentityName = 'id-polyedge-conduit-shadow-qset-v7-writer'
var processorIdentityName = 'id-polyedge-conduit-shadow-qset-v7-processor'
...
resource writerRawContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    description: 'Only write or append qset-v7 preflight and campaign raw prefixes; the custom role has no delete, move, or container actions.'
  }
}
...
resource processorCampaignWriter 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    description: 'Only write or append qset-v7 campaign research and report prefixes; the custom role has no delete, move, or container actions.'
  }
}
