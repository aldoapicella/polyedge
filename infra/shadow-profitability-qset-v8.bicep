...
var campaignId = 'campaign-2026-09-09-qset-v8'
var rawContainerName = 'polyedge-shadow-qset-v8-events'
var researchContainerName = 'polyedge-research-qset-v8'
var controlContainerName = 'polyedge-qset-v8-control'
var eventIndexTableName = 'ShadowQsetV8EventIndex'
var chartSeriesTableName = 'ShadowQsetV8ChartSeries'
var marketCatalogTableName = 'ShadowQsetV8MarketCatalog'
var writerIdentityName = 'id-polyedge-conduit-shadow-qset-v8-writer'
var processorIdentityName = 'id-polyedge-conduit-shadow-qset-v8-processor'
...
resource writerRawContributor 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    description: 'Only write or append qset-v8 preflight and campaign raw prefixes; the custom role has no delete, move, or container actions.'
  }
}
...
resource processorCampaignWriter 'Microsoft.Authorization/roleAssignments@2022-04-01' = {
  ...
  properties: {
    ...
    description: 'Only write or append qset-v8 campaign research and report prefixes; the custom role has no delete, move, or container actions.'
  }
}
