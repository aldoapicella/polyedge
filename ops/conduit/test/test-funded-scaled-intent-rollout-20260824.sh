...
helper=$repo/ops/conduit/bin/polyedge-funded-signer-scaled-intent-rollout-20260824
old_image=ghcr.io/aldoapicella/polyedge-venue-probe@sha256:976492b39921417ec8db01bcc38b09cc42c97afd4bb573047d4284db0a9ceeb8
recovery_image=ghcr.io/aldoapicella/polyedge-venue-probe@sha256:212a34d97075ff74b57681aff65e49913431e6caf2f7c015104102c62837e6f3
...
make_fixture() {
  ...
  /usr/bin/jq -n --arg recovery "$recovery_image" --arg producer "$producer_image" '{
    ...
    recoveryImage:$recovery,signerImageUnchanged:$recovery,producerImageUnchanged:$producer,
...
run_helper "$success"
pending=$success/ring/activation/20260824T083626Z-funded-signer-scaled-intent-rollout.pending.json
...
/usr/bin/jq -e '.producerWasActive == true' "$active/ring/activation/20260824T083626Z-funded-signer-scaled-intent-rollout.pending.json" >/dev/null
...
interrupted_pending=$interrupted/ring/activation/20260824T083626Z-funded-signer-scaled-intent-rollout.pending.json
...
printf 'funded scaled-intent rollout tests passed\n'
